...
export default function Project({ title, description, tags, imageUrl, githubUrl }: ProjectProps) {
    ...
    return (
        <motion.div
            ...
            rounded-lg sm:group-even:pl-8 hover:bg-gray-200 transition dark:bg-white/10 dark:hover:bg-white/20 dark:text-white">
                <div className="pt-4 pb-10 px-5 sm:pl-10 sm:pr-2 sm:pt-10 sm:max-w-[50%] flex flex-col h-full
                sm:group-even:ml-[28rem]">
                ...
                className="hidden sm:block absolute top-5 -right-40 w-[38.25rem] rounded-t-lg shadow-2xl
                transition
