...
export default function Header() {
  return <header className="z-[999] relative">
    ...
    sm:top-6 sm:h-[3.25rem] sm:w-[38rem] sm:rounded-full"
        
        /* Add a bounce animation on the navbar when page loads using primer-motion */
    ...
    <nav className={"flex fixed top-[0.15rem] left-1/2 h-12 -translate-x-1/2 py-2 sm:top-[1.7rem] sm:h-[initial] sm:py-0"}>
        ...
        <ul className={`${robotoMono.className} flex w-[22rem] flex-wrap items-center justify-center gap-y-1 text-[0.9rem] font-medium text-purple-700 sm:w-[initial] sm:flex-nowrap sm:gap-2`}>
            <motion.span 
